...
const ShoppingCart = () => {
    ...
    return (
        <div>
            <button className='single-main-cart' onClick={handleOpen}>Add To Cart</button>
            <Modal
                open={open}
                onClose={handleClose}
            ...
            >
                <Box sx={style}>
                    ...
                    <div className="shopping-box d-f">
                        <div className="shopping-item d-f jc-sb align-center">
                            <div><img src="/images/shopping1.png" alt="shopping1" /></div>
                            <div>
                                <h3 className="shopping-item-title">Asgaard sofa</h3>
                                <div className="shopping-item-info d-f align-center">
                                    <div className="shoping-item-quantity">1</div>
                                    <div className="shopping-item-sign">X</div>
                                    <div className="shopping-item-price">Rs. 250,000.00</div>
                                </div>
                            </div>
                            <button className='btn-clear d-b'><img src="/images/delete.png" alt="delete" /></button>
                        </div>
                        <div className="shopping-subtotal d-f align-center">
                            <div className="shopping-subtotal-title">Subtotal</div>
                            <div className="shopping-subtotal-value">Rs. 250,000.00</div>
                        </div>
                    </div>
